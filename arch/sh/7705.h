...
#ifndef _CPU_SH_7705_H
#define _CPU_SH_7705_H
...
#define PN     (*(volatile struct st_pn    *)0xA400013A)/* PN    Address*/
...
#define USB    (*(volatile struct st_usb   *)0xA40A0008)/* UBC   Address*/
