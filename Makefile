...
ASM_SRC=bootstrap.s arch/sh/exception_handler.S arch/sh/interrupt_handler.S arch/sh/tlb_handler.S gcc_fix/udivsi3_i4i.S initialize.s display/T6K11/drawall.s display/T6K11/setpixel.s sys/sh/memcpy.S sys/sh/memset.S sys/sh/strcpy.S sys/sh/strlen.S sys/sh/strcmp.S
